								...
								<div class="modal_right1" style="overflow: hidden;">
																...
																<div class="Jv7Aj mArmR   pZp3x">
																	<div class="RR-M-  TKzGu  " role="button" tabindex="-1">
																		...
																		<a class="_2dbep qNELH kIKUG"
																			href="/starting/userProfile?client_id=${comment.comment_id }"
																			tabindex="0"
																			style="width: 32px; height: 32px; display: block;">
																			<img
																			src="/img/${clientlist.get(status.count-1).client_img }"
																			class="_6q-tv">
																		</a>
																	</div>
																</div>
																	...
																	<h3 class="_6lAjh ">
																		<div>
																			<span><a style="font-size: 15px;"
																				href="/starting/userProfile?client_id=${comment.comment_id }">${comment.comment_id}</a></span>
																		</div>
																	</h3>
									...
									<div class="comment">
										<form action="comment/save" method="post">
											<input type="hidden" name="comment_no" value="0"> <input
												type="hidden" name="comment_whiteboard_no"
												value="${whiteboard.whiteboard_no }"> <input
												type="hidden" name="comment_id" value="${client.client_id }">
											<input id="input-comment" name="comment_content"
												style="width: 400px; margin-left: 16px;" class="input-comment" type="text"
												placeholder="댓글 달기...">
